...
from .cls_focal import FocalTransformer
...
class CLIP(nn.Module):
    def __init__(self, config: dict,):
        ...
        self.visual = FocalTransformer(
            ...
            focal_levels=spec_vision['FOCAL_LEVELS'], 
            focal_topK=128, # 
            use_conv_embed=spec_vision['USE_CONV_EMBED'], 
            use_shift=False, 

            use_layerscale=True # spec_vision.get('LAYER_SCALE', False)
        )
